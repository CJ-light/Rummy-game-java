...
public class Table extends JFrame implements ActionListener
{
	...
	void redraw(){
		...
		if (player == 0){
			if (gameEnd == true){
				p1Instructions.setText(tempWin);
				p2Instructions.setText(tempWin);
			}
			...
			if (added == true && discarded == false){
				p1Instructions.setText("Player 1's turn: Lay a set or add card to the Stack.");
				p2Instructions.setText("Not your turn");
			}
		}
		if (player == 1){
			...
			if (added == true && discarded == false){
				p1Instructions.setText("Not your turn.");
				p2Instructions.setText("Player 2's turn: Lay a set or add card to the Stack.");
			}
		}
	}
	...
	String CheckWin(int deckSize, Hand p1Hand, Hand p2Hand){
		if (deckSize > 0){
			if (p1Hand.getNumberOfCards() == 0){
				System.out.println("Player 1 doesn't have any more cards.");
				return "Player 1 Wins!";
			}
			else if (p2Hand.getNumberOfCards() == 0){
				System.out.println("Player 2 doesn't have any more cards.");
			...
			System.out.println("Points: " + Integer.toString(p1Eval) + " to " + Integer.toString(p2Eval));
			if (p1Eval < p2Eval)
				return "Player 1 Wins!";
